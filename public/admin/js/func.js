...
$('input#name2').keyup(function(event) {
/* Act on the event */
var title, slug;
    ...
    slug = slug.replace(/\@\-|\-\@|\@/gi, '');
    //In slug ra textbox có id “slug”
    $('input#slug2').val(slug);

});

$('input#name3').keyup(function(event) {
...
var title, slug;
    ...
    slug = slug.replace(/\@\-|\-\@|\@/gi, '');
    //In slug ra textbox có id “slug”
    $('input#slug3').val(slug);

});


$('input#name4').keyup(function(event) {
    ...
    var href = $(this).attr('href');
        jQuery.ajax({
          ...
          success: function(data) {
            $('#editTitle').val(data.desc.categorychiTitle);
            $('#editSlug').val(data.desc.categorychiSlug);
            $('#editId').val(data.desc.categorychiId);
          }
        });
});

$(document).on('click', '.editSidebar', function(e) {
    e.preventDefault();
    var href = $(this).attr('href');
        jQuery.ajax({
          url: href,
...
$(document).on('click', '.editVocabulary', function(e) {
    e.preventDefault();
    var href = $(this).attr('href');
        jQuery.ajax({
          url: href,
